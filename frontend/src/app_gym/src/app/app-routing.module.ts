...
const routes: Routes = [
  ...
  { path: 'change-user-info/:id/editar', component: ChangeUserInfoComponent},
  ...
  { path: 'clases-form/:id/editar', component: ClasesFormComponent},
  { path: 'clases-plan', component: ClasesPlanComponent},
  { path: 'plan-form', component: PlanFormComponent},
  { path: 'plan-form/:id/editar', component: PlanFormComponent},
